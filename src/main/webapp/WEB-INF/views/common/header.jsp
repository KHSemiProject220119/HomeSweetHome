				...
				<div class="main-nav-container-wrapper">
					<div class="main-nav-container">
						<div class="main-nav-wrapper1">
							<a class="home-menu" href="<%= request.getContextPath() %>/common/home">Home Sweet Home</a>
						</div>
							...
							<div class="search-member-wrapper">
								...
								<% if(loginMember == null) { %>
									<div class="member-menu-wrapper">
										<a class="member-menu" href="<%= request.getContextPath() %>/member/login">로그인</a>
										<a class="member-menu" href="<%= request.getContextPath() %>/member/signup">회원가입</a> 
								...
								<% } else { %>
									<div class="login-member-menu-wrapper">
										<a class="member-menu" href="<%= request.getContextPath() %>/member/scrap">스크랩북</a>
										<a class="member-menu" href="<%= request.getContextPath() %>/member/notification">알림</a> 
										<a class="member-menu" href="<%= request.getContextPath() %>/member/cart">
										<image class="cart-btn" src= "<%=request.getContextPath() %>/images/cart.png;">
										</a>
										<a class="member-menu" href="<%= request.getContextPath() %>/member/mypage">마이페이지</a>
									</div>
								<% }
								  }%>
